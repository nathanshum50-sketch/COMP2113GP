...
* **Random Generation:** Generating enemies and cards, latter adjusted for rarity.
* **Data Structures:** Use of linked lists to store card lists, struct to store player state, class to store game information.
...
* **Distinct Enemies:** Enemies have distinct strengths, weaknesses, and flavor. Unique Bosses at the ends of levels.
