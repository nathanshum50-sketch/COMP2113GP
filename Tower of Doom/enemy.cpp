...
Card generateEnemyCard(string enemy, Card* cardPoolHead, char difficulty) {
    ...
    switch (selectedRarity) {
        case 0: cardno = rand() % 20 + 1; break;      // Cards 001-020 (Rarity 0)
        case 1: cardno = rand() % 20 + 21; break;     // Cards 021-040 (Rarity 1)  
        case 2: cardno = rand() % 20 + 41; break;     // Cards 041-060 (Rarity 2)
        case 3: cardno = rand() % 20 + 61; break;     // Cards 061-080 (Rarity 3)
        case 4: cardno = rand() % 20 + 81; break;     // Cards 081-100 (Rarity 4)
        default: cardno = rand() % 20 + 1; 
    }
